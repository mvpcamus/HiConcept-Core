var logger = require(_homePath+'/lib/logger.js').Logger;
var errors = require(_homePath+'/lib/errCodes.json');
var logSpacer = require(_homePath+'/lib/environment.json').LogSpacer;
