...
module.exports = function(app) {
    ...
    app.get('/', function(request, response) { //userMain Form
    ...
    app.get('/admin/user', function(request, response) { //userUpdate Form
        if (request.session.user_id) {
    ...
    app.get('/admin/signup', function(request, response) { //userSignup Form
        if (request.session.user_id) {
            response.redirect('/');
        } else {
    ...
    app.get('/admin/login', function(request, response) { //userLogin Form
        if (request.session.user_id) {
            response.redirect('/');
        } else {
    ...
    app.get('/admin/user/profile', authen, users.readUser); //TODO
    app.post('/admin/signup', users.createUser); //TODO
    app.post('/admin/user/update', authen, users.updateUser); //TODO
    app.post('/admin/user/delete', authen, users.deleteUser); //TODO
