...
module.exports = function(app) {
    ...
    app.post('/topics/:topic_id', authen.core, author.core, data.publish);
    app.get('/topics/:topic_id', authen.core, author.core, data.subscribe);

    // HiConcept core websocket routes
    var websocket=require(_homePath+'/lib/controllers/websocket.js');
    app.ws('/topics/:topic_id', authen.ws, author.ws, websocket.route);
}
